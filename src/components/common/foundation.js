    ...
    <div className="foundation" id="foundation">
                ...
                <div className="press-articles__articles-list">
                    ...
                    <div className="press-articles__article-item">
                        <div className="press-articles__article">
                            ...
                            <a className="press-articles__visit-btn" href="https://www.linkedin.com/in/mike-n-6735ba104/"
                                target="_blank">in</a>    <a className="press-articles__visit-btn" href="https://bitcointalk.org/index.php?action=profile;u=157316" onclick="return false;" target="_blank">BitcoinTalk</a>
                    ...
                    <div className="press-articles__article-item">
                        <div className="press-articles__article">
                            ...
                            <a className="press-articles__visit-btn" href="https://twitter.com/Crypt0Hybr1d"
                               onclick="return false;" target="_blank">Twitter</a>    <a className="press-articles__visit-btn" href="https://bitcointalk.org/index.php?action=profile;u=158505" onclick="return false;" target="_blank">BitcoinTalk</a>
		...
		<div className="press-articles__article-item">
                        <div className="press-articles__article">
                            ...
                            <b><p className="press-articles__description">Current industry sector:</p></b> Web App
                            Development
                            <b><p className="press-articles__description">Previous industry experience:</p></b> -
                        </div>
                    </div>	
                    ...
                    <div className="press-articles__article-item">
                        <div className="press-articles__article">
                            <h1 className="press-articles__sub-heading">SotBlad</h1>
                            <a className="press-articles__visit-btn" href="https://twitter.com/sotblad" target="_blank">Twitter</a>    <a className="press-articles__visit-btn" href="https://bitcointalk.org/index.php?action=profile;u=883063" target="_blank">BitcoinTalk</a>
                            <b><p className="press-articles__description">Started in crypto:</p></b> 5 May 2016
                            <b><p className="press-articles__description">Current industry sector:</p></b> Security, Web
                            App Development
                            <b><p className="press-articles__description">Previous industry experience:</p></b> Web
                            Hosting
                        </div>
                    </div>
                    ...
                    <div className="press-articles__article-item">
                        <div className="press-articles__article">
                            <h1 className="press-articles__sub-heading">Swtrse</h1>
                            <a className="press-articles__visit-btn" href="https://twitter.com/swtrse" target="_blank">Twitter</a>    <a className="press-articles__visit-btn" href="bcttalk" onclick="return false;" target="_blank">BitcoinTalk</a>
                            <b><p className="press-articles__description">Started in crypto:</p></b> September 2014
                            <b><p className="press-articles__description">Current industry sector:</p></b> I.T
                            <b><p className="press-articles__description">Previous industry experience:</p></b> -
                        </div>
                    </div>
                    ...
                    <div className="press-articles__article-item">
                        <div className="press-articles__article">
                            <h1 className="press-articles__sub-heading">Theboccet</h1>
                            <a className="press-articles__visit-btn" href="https://twitter.com/theboccet"
                               target="_blank">Twitter</a>    <a className="press-articles__visit-btn" href="bcttalk" onclick="return false;" target="_blank">BitcoinTalk</a>
                            <b><p className="press-articles__description">Started in crypto:</p></b> November 2013
                            <b><p className="press-articles__description">Current industry sector:</p></b> ISP CS
                            <b><p className="press-articles__description">Previous industry experience:</p></b> Computer
                            Hardware Maintenance Service ; Electronics Vendor.
                        </div>
                    </div>
