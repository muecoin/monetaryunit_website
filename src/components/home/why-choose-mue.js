    ...
    <section className="why-choose-mue__container">
        <div className="why-choose-mue__intro">
          <div className="why-choose-mue__intro-text-container">
            ...
            <p className="why-choose-mue__intro-paragraph">Recent migration to the X11 code base (based on Dash) allows us to reach a larger market of miners and brings added security with a likely rise in price from a more advanced hash rate. The MasterNode network manages a pool of funds which is set aside to fund the project moving forward. Proposals put before MasterNodes allows for a democratic process over future decisions unlike other currencies in the market.</p>
