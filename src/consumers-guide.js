...
export default () => {
  return renderComponent(
    <Layout className="layout">
        ...
        <GuideIntro title="For Consumers">
          ...
          <p className="guide-intro__paragraph">You can also purchase directly on: <a className="guide-intro__paragraph-link" href="https://bittrex.com/Market/?MarketName=BTC-MUE" target="_blank">Bittrex</a>.</p>
          <p className="guide-intro__paragraph">Get 150% bonus when opening a new account at our Forex trading platform: <a className="guide-intro__paragraph-link" href="https://muex.io/Forex" target="_blank">muex.io/Forex</a>.</p>
          <p className="guide-intro__paragraph">or use one of our <a className="guide-intro__paragraph-link" href="https://www.coinpayments.net/store-directory-coin-MUE" target="_blank">online merchants</a>.</p>
        </GuideIntro>
